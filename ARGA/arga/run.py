...
flags.DEFINE_integer('features', 1, 'Whether to use features (2) or not (0).')
...
data_list = ['BlogCatalog', 'Flickr', 'ACM', 'Amazon', 'Enron', 'Disney']
dataname = data_list[0]       # 'cora' or 'citeseer' or 'pubmed'
